            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 ">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="#" className="flex items-center mb-4 space-x-3 ">
                        ...
                        <span className="self-center text-4xl font-semibold whitespace-nowrap dark:text-white">Metablocks</span>
                    </a>
                ...
                <span className="block text-2xl text-gray-500 text-center dark:text-gray-400">Made with 🍆 and code by <a className="underline duration-300 hover:text-9xl hover:no-underline" href="https://linktr.ee/ishaanminocha">Team Level Talk</a>.</span>
            </div>
        </footer>
